...
from assets.TissueAnnoLayerData import TissueAnnoLayerData
...
data = TissueAnnoLayerData('/home/antoine/antoine/cervical_model/pytorch_model/classification/TissueNet/TissueNet_Detect_Lesions_in_Cervical_Biopsies_-_Train_Annotations.csv',
                    '/mnt/hd1/antoine/TissueNet/data/Train_Metadata/tif', page =2 ,size = 2048,
                    transform=transform)

#print(len(data))
data_size = len(data)
n_train = int(data_size * 0.8)
train = Subset(data,range(int(data_size * 0.8)))
val = Subset(data,range(int(data_size * 0.8),data_size))
...
t.save(resnet50.state_dict(),'epoch_final_layer2_aug_res50_no_duplicate_'+str(ac)+'.pth')